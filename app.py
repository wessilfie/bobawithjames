...
def signup():
    ...
    html = '<html><head></head><body><p>Hi there '+name+'!<br><br>You are scheduled for boba with James. (*＾▽＾)／<br><br>Location: '+location+'.<br>Time: '+time+'.<br><br>If you have any questions, email James (cced on this email), text James at (949)554-5535 or message him on <a href="https://www.facebook.com/jamesxue100">Facebook</a>.</p></body</html>'
